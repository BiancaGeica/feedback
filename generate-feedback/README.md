...
The primary goal is to provide reliable, non-sensitive data for testing the main project's data processing and analysis scripts.
...
- Creating venv steps:
    ...
    - the script uses `json`, `os`, `pickle`, `random`
    - they can be installed with `pip install json os pickle random`
